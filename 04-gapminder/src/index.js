...
csv("../data/population_total.csv").then(function (data) {
	data.forEach;
});

csv("../data/life_expectancy_years.csv").then(function (data) {
	console.log(data);
});

csv("../data/income_per_person_gdppercapita_ppp_inflation_adjusted.csv").then(
	function (data) {
		console.log(data);
	}
);
